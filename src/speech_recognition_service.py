...
class SpeechRecognizer(speech_recognition_open_api_pb2_grpc.SpeechRecognizerServicer):
    ...
    def __init__(self):
        ...
        self.MODEL_BASE_PATH = "/home/neo/vakyansh_2022/speech-recognition-open-api/"
        self.BASE_PATH = "/home/neo/vakyansh_2022/speech-recognition-open-api/"

        gpu = get_env_var('gpu', 'True')
